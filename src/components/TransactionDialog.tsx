    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button
                    size="icon"
                    className="fixed bottom-8 right-8 h-14 w-14 rounded-full shadow-2xl hover:scale-105 transition-all bg-primary text-primary-foreground z-50 animate-in zoom-in duration-300"
                >
